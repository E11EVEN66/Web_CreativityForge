...
function drawShape() {
  ...
  grd[0].addColorStop(0, `hsla(294, 100%, 50%, ${alpha})`);
  grd[0].addColorStop(1, `hsla(294, 100%, 50%, 0)`);
  ...
  grd[1].addColorStop(0, `hsla(334, 100%, 50%, ${alpha})`);
  grd[1].addColorStop(1, `hsla(334, 100%, 50%, 0)`);
