...
function drawShape() {
  ...
  grd[0].addColorStop(0, `hsla(167, 100%, 64%, ${alpha})`);
  grd[0].addColorStop(1, `hsla(167, 100%, 64%, 0)`);
  ...
  grd[1].addColorStop(0, `hsla(225, 100%, 50%, ${alpha})`);
  grd[1].addColorStop(1, `hsla(225, 100%, 50%, 0)`);
