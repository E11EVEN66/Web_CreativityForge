...
function drawShape() {
  ...
  grd[0].addColorStop(0, `hsla(258, 100%, 50%, ${alpha})`);
  grd[0].addColorStop(1, `hsla(258, 100%, 50%, 0)`);
  ...
  grd[1].addColorStop(0, `hsla(253, 100%, 50%, ${alpha})`);
  grd[1].addColorStop(1, `hsla(253, 100%, 50%, 0)`);
